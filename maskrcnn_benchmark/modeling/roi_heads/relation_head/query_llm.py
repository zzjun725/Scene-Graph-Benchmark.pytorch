...
class CommonsenseValidator:
    def __init__(self, top_k=20, max_cache_size=10000, llm_model='llava-v1.6-vicuna-7b', use_api=False): #'gpt-3.5-turbo-instruct'
        self.cache_hits = 0
        self.top_k = top_k
    ...
    def query_llava(self, edge, image, verbose=True):
        if self.use_api:
            input = {
                "image": image,
